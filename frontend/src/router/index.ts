...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/exchange', name: 'exchange-list', component: () => import('../pages/exchange/ExchangeListPage.vue'), meta: { requiresAuth: true } },
    { path: '/exchange/create', name: 'exchange-create', component: () => import('../pages/exchange/ExchangeCreatePage.vue'), meta: { requiresAuth: true } },
    { path: '/exchange/:id', name: 'exchange-detail', component: () => import('../pages/exchange/ExchangeDetailPage.vue'), meta: { requiresAuth: true } },
